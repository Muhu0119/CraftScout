...
<head>
    ...
    <body>
        ...
        <a href="index.php"><img src="img/Logo2.png" class="logo" alt="" /></a>
            ...
            <div>
                <ul id="navbar">
                    ...
                    <li><a class="active" href="Community.php">Community</a></li>
        ...
        <section id="page-header" class="blog-header">
            <h2>#JoinUs</h2>
            <p>Discover the impact! Dive into all our community project case studies!</p>
        </section> 
        ...
        <section id="blog">
            ...
            <div class="grid-container">
                <div class="grid-item">Community Activities</div>
                <div class="grid-item">Our Events</div>
                <div class="grid-item">Special Occasion</div>
                <div class="grid-item">Community Woodshop</div>  
